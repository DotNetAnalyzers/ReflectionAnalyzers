...
namespace RoslynSandbox
{
    ...
    class Foo
    {
        ...
        public static double Static(double value) => value;
                ...
                AnalyzerAssert.CodeFix(Analyzer, Fix, ExpectedDiagnostic, code, fixedCode, fixTitle: "Use: BindingFlags.Public | BindingFlags.Static | BindingFlags.DeclaredOnly, new[] { typeof(int) }.");
...
namespace RoslynSandbox
{
    ...
    class Foo
    {
        ...
        public static double Static(double value) => value;
                ...
                AnalyzerAssert.CodeFix(Analyzer, Fix, ExpectedDiagnostic, code, fixedCode, fixTitle: "Use: BindingFlags.Public | BindingFlags.Static | BindingFlags.DeclaredOnly, new[] { typeof(double) }.");
            }
        }
    }
